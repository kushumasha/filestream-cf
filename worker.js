...
const BOT_TOKEN = "8470505825:AAGKP-Dz1q6FeaZvGAFX1sg_yRSZh93lxF0"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "Dz1q6FeaZvGAFX1sg_yRSZh93lxF0"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 7484783061; // Insert your telegram account id.
const BOT_CHANNEL = -1003016384538; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "8470505825"; // Insert a powerful secret text and keep it safe.
